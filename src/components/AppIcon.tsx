...
export const AppIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className={className}>
    ...
    <g transform="translate(10, 10) scale(0.8)">
      ...
      <rect x="20" y="25" width="60" height="60" rx="6" fill="#bef264" stroke="#1e293b" strokeWidth="6" strokeLinejoin="round" />
      ...
      <g transform="translate(75, 75) scale(1.1)">
        ...
        <circle cx="0" cy="0" r="20" fill="#fde68a" stroke="#1e293b" strokeWidth="5" />
        <circle cx="0" cy="0" r="14" fill="#fcd34d" stroke="#1e293b" strokeWidth="2" />
        <text x="0" y="8" fontFamily="Arial, sans-serif" fontSize="28" fontWeight="bold" fill="#1e293b" textAnchor="middle">$</text>
      </g>
    </g>
  </svg>
);
